...
class Loggers():
    ...
    def on_train_batch_end(self, model, ni, imgs, irs, targets, rgb_paths, ir_paths, vals):
        ...
        if self.plots:
            if ni < 3:
                ...
                f_i = self.save_dir / f'train_batch{ni}_ir.jpg'
                plot_images(imgs, targets, rgb_paths, f)
                plot_images(irs, targets, ir_paths, f_i)
                # plot_images(irs, targets, ir_paths, f)
